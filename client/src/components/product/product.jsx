        ...
        <div className="section">
            <div className="container-fluid py-5 bg-white">
                <div className="row">
                    ...
                    <span className="text-center ">Explore a World of Choices Across Our Most Popular</span>
                    <div className="col-12">
                        <div>
                            <ul className="nav nav-pills justify-content-center p-3 mb-3" id="pills-tab" role="tablist">
                                ...
                                <li className="nav-item" role="presentation">
                                    <button onClick={()=>ListByRemarkRequest('top')} className="nav-link" id="pills-top-tab" data-bs-toggle="pill" data-bs-target="#pills-top" type="button" role="tab" aria-controls="pills-disabled" aria-selected="false">Top</button>
                                </li>
                                <li className="nav-item" role="presentation">
                                    <button onClick={()=>ListByRemarkRequest('special')} className="nav-link " id="pills-special-tab" data-bs-toggle="pill" data-bs-target="#pills-special" type="button" role="tab" aria-controls="pills-disabled" aria-selected="false">Special</button>
                                </li>
                            </ul>
                                                          ...
                                                          let price=<p className="bodyMedium text-dark my-1">Price:${item['price']}</p>
                                                            ...
                                                            return(
                                                                <div className="col-md-3 col-lg-3 col-sm-6 col-12 p-2">
                                                                    <Link to={'/details/'+item['_id']} className="card shadow-sm rounded-3 h-100 bg-white ">
                                                                        <img className="w-100 rounded-top-2" src={item['image']}/>
                                                                        <div>
                                                                            <p className="bodySmal my-1 text-secondary">{item['title']}</p>
                                                                            {price}
                                                                            <StarRatings
                                                ...
                                                <div className="row">
                                                    {
                                                        ListByRemark.map((item,i)=>{
                                                            ...
                                                            return(
                                                                <div className="col-md-3 col-lg-3 col-sm-6 col-12 p-2">
                                                                    <Link to={'/details/'+item['_id']} className="card shadow-sm rounded-3 h-100 bg-white">
                                                                        <img src={item['image']} className="w-100 rounded-top-2"/>
                                                                        <div className="card-body">
                                                                            <p className="bodySmal text-secondary my-1">{item['title']}</p>
                                                                            {price}
                                                                            <StarRatings
